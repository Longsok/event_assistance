<x-admin-layout>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-white">Schedule Templates — Select a Category</h2>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="{{ route('admin.schedule-templates.show', $category) }}"
           class="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-indigo-500 transition group">
            ...
            <p class="text-gray-400 text-sm">{{ $category->schedule_templates_count }} sessions</p>
