<x-admin-layout>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-white">Budget Templates — Select a Category</h2>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="{{ route('admin.budget-templates.show', $category) }}"
           class="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-indigo-500 transition group">
            ...
            <p class="text-gray-400 text-sm">{{ $category->budget_templates_count }} budget items</p>
